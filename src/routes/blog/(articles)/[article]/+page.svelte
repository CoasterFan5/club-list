...
<div class="wrap">
	<div class="article">
		...
		<hr/>
		<p>Clubsaurus is developing the next generation of club management platforms. Our goal is to establish a hub for an organization's clubs, with a focus on student leadership, accessible information, and security. Pretty cool, right? <Link href="/get-started">Get Started</Link></p>
	</div>
</div>
